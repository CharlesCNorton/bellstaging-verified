...
(*                                                                            *)
(*  --- Transition and temporal integrity ---                                 *)
...
(*  17. Route Microbiology culture results into Antibiotics module for         *)
(*      culture-directed therapy selection.                                   *)
(*  18. Prove FeedingProtocol.can_restart_feeds returns false during           *)
(*      active NEC (classification >= IIA): refeeding safety invariant.       *)
(*  19. Wire NeonatalOrganFailure scores into classifier or document          *)
(*      why organ failure assessment is intentionally disconnected.           *)
(*  20. Calibrate DifferentialDiagnosis confidence weights against             *)
(*      published sensitivity/specificity data.                               *)
(*  21. Refine SurgicalProcedures.initial_procedure_for_perforation           *)
(*      to account for NET trial nuance (Moss et al. 2006).                  *)
(*                                                                            *)
(*  --- Data model improvements ---                                           *)
(*  22. Replace Prognosis nat with record { low; mid; high } to               *)
(*      reflect published ranges rather than point estimates.                 *)
(*  23. Guard RiskFactors.risk_score against nat underflow (protective         *)
(*      > raw clips to 0 silently; document or use Z).                       *)
(*                                                                            *)
(*  --- Validation ---                                                        *)
(*  24. Add module with published case studies (Sharma & Hudak 2013,          *)
(*      Neu & Walker 2011) as witness validation suite.                       *)
(*  25. Prove suggests_volvulus and suggests_sepsis_without_nec are            *)
